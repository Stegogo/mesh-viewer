...
Mesh::Mesh()
{
    ...
    // Register material for face shading
//    faceShadingMaterial = nullptr;
//    faceShadingEffect = nullptr;
//    addFaceShadingMaterial();
...
//void Mesh::addFaceShadingMaterial()
//{
//    // Create custom material
//    faceShadingMaterial = new Qt3DRender::QMaterial();

//    // Create effect, technique, render pass and shader
//    faceShadingEffect = new Qt3DRender::QEffect();
//    Qt3DRender::QTechnique *gl3Technique = new Qt3DRender::QTechnique();
//    Qt3DRender::QRenderPass *gl3Pass = new Qt3DRender::QRenderPass();
//    Qt3DRender::QShaderProgram *glShader = new Qt3DRender::QShaderProgram();
...
//    // Add the technique to the effect
//    faceShadingEffect->addTechnique(gl3Technique);

//    // Set the effect on the materials
//    // and add it to the entity
//    faceShadingMaterial->setEffect(faceShadingEffect);
...
//    // Add parameters for material
//    faceShadingMaterial->addParameter(ka);
//    faceShadingMaterial->addParameter(kd);
//    faceShadingMaterial->addParameter(ks);
//    faceShadingMaterial->addParameter(shininess);
//    faceShadingMaterial->addParameter(wireframeMode);
